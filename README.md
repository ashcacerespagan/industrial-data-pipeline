# X-Ray & Panel Inspection Data Pipeline
...
- **Query & Analytics (`src/query_module.py`)**: Executes analytical SQL queries to evaluate first-pass yield rates across panel models and flag critical hardware defects for technical analysis.
